...
* [observability] Demonstrate backend-observed telemetry pipeline latency. The
  load generator emits synthetic log probe Events, OpenSearch calculates the
  time from emission to ingest, and Grafana shows latency, probe availability,
